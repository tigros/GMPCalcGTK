...
namespace Math.Mpfr.Native
{
	...
	public unsafe struct __mpfr_struct //16 bytes
	{
		uint _mpfr_prec;  //4
		int _mpfr_sign;   //4
		int _mpfr_exp;    //4
    ...
    /*    internal void Initializing()
        {
            Math.Gmp.Native.size_t length = 12U  + (size_t)IntPtr.Size;
	...
	*/
		...
		public mpfr_t()
		{
			mpfr_ptr = (__mpfr_struct*)Marshal.AllocHGlobal(sizeof(__mpfr_struct) + 16);
		}
   ...
   /*     public mpfr_exp_t _mpfr_exp
        {
            get
            {
                return Marshal.ReadInt32(Pointer, 8);
            }
        }
*/
        /// <summary>
     ...
     /*   [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public override IntPtr _mp_d_intptr
        {
            get
            {
                return Marshal.ReadIntPtr(Pointer, 12);
            }
            set
            {
                Marshal.WriteIntPtr(Pointer, 12, value);
            }
        }
